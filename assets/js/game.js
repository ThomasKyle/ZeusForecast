...
var forecastBox = $("#weatherForecast");
var cityArray;
...
function returnUVIndex(coordinates) {
    ...
    $.get(queryURL).then(function(response){
        ...
        currentWeather.append(`<p>UV Index: <span class="text-${textColour} uvPadding" style="background-color: ${uvSeverity};">${currUVIndex}</span></p>`);
    })
}
